...
class CommitMergerTest {
	...
	public void testMergeTwoCommits() {
		def localCommit = [
				new CommitBundle(released: false, version: '1.4-SNAPSHOT', commitTime: new Date(2014, 1, 12, 12, 0).time, message: 'DAM-126'),

				new CommitBundle(released: true, version: '1.3', commitTime: new Date(2014, 1, 10, 9, 0).time, message: '[maven-release-plugin] prepare release dam-war-1.3'),
				new CommitBundle(released: true, version: '1.3', commitTime: new Date(2014, 1, 9, 16, 0).time, message: 'DAM-125'),
				new CommitBundle(released: true, version: '1.3', commitTime: new Date(2014, 1, 8, 10, 0).time, message: 'DAM-124'),

				new CommitBundle(released: true, version: '1.2', commitTime: new Date(2014, 1, 7, 12, 0).time, message: '[maven-release-plugin] prepare release dam-war-1.2'),
				new CommitBundle(released: true, version: '1.2', commitTime: new Date(2014, 1, 7, 11, 30).time, message: 'DAM-123'),
				new CommitBundle(released: true, version: '1.2', commitTime: new Date(2014, 1, 5, 9, 30).time, message: 'DAM-122'),

				new CommitBundle(released: true, version: '1.1', commitTime: new Date(2014, 1, 2, 14, 0).time, message: '[maven-release-plugin] prepare release dam-war-1.1'),
				new CommitBundle(released: true, version: '1.1', commitTime: new Date(2014, 1, 2, 10, 30).time, message: 'DAM-121')
		]

		def dependencyCommit = [
				new CommitBundle(released: false, version: '1.4-SNAPSHOT', commitTime: new Date(2014, 1, 11, 11, 0).time, message: 'DAM-116'),

				new CommitBundle(released: true, version: '1.3', commitTime: new Date(2014, 1, 10, 16, 0).time, message: 'DAM-115'),
				new CommitBundle(released: true, version: '1.3', commitTime: new Date(2014, 1, 10, 10, 0).time, message: 'DAM-114'),

				new CommitBundle(released: true, version: '1.2', commitTime: new Date(2014, 1, 7, 9, 45).time, message: 'DAM-113'),
				new CommitBundle(released: true, version: '1.2', commitTime: new Date(2014, 1, 5, 8, 30).time, message: 'DAM-112'),

				new CommitBundle(released: true, version: '1.1', commitTime: new Date(2014, 1, 2, 8, 30).time, message: 'DAM-111')
		]
